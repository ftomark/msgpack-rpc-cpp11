...
void default_dispatcher::dispatch(RPCLIB_MSGPACK::sbuffer const &msg) {
...
response default_dispatcher::dispatch_call(RPCLIB_MSGPACK::object const &msg,
                                   bool suppress_exceptions) {
    call_t the_call;
...
response default_dispatcher::dispatch_notification(RPCLIB_MSGPACK::object const &msg,
                                           bool suppress_exceptions) {
...
void EventManager::enforce_arg_count(std::string const &func, std::size_t found,
                                   std::size_t expected) {
...
void EventManager::enforce_unique_name(std::string const &func) {
