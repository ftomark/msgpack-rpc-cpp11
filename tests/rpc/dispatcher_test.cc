...
protected:
    rpc::detail::default_dispatcher dispatcher;
};
...
TEST_F(binding_test, freefunc_void_zeroarg) {
    const unsigned char raw_msg[] = "\x94\x00\x00\xb2\x64\x75\x6d\x6d\x79\x5f"
                                    ...
                                    "\x72\x67\x90";
    dispatcher.event_handle.bind("dummy_void_zeroarg", &dummy_void_zeroarg);
    raw_call(raw_msg);
...
TEST_F(binding_test, freefunc_void_singlearg) {
    ...
    dispatcher.event_handle.bind("dummy_void_singlearg", &dummy_void_singlearg);
    raw_call(raw_msg);
...
TEST_F(binding_test, freefunc_void_multiarg) {
    ...
    dispatcher.event_handle.bind("dummy_void_multiarg", &dummy_void_multiarg);
    raw_call(raw_msg);
...
TEST_F(binding_test, memfunc_void_zeroarg) {
    ...
    const unsigned char raw_msg[] = "\x94\x00\x00\xb2\x64\x75\x6d\x6d\x79\x5f"
                                    "\x76\x6f\x69\x64\x5f\x7a\x65\x72\x6f\x61"
                                    "\x72\x67\x90";
    dispatcher.event_handle.bind("dummy_void_zeroarg", [&md]() { md.dummy_void_zeroarg(); });
    raw_call(raw_msg);
}
...
TEST_F(binding_test, memfunc_void_singlearg) {
    ...
    const unsigned char raw_msg[] = "\x94\x00\x00\xb4\x64\x75\x6d\x6d\x79\x5f"
                                    "\x76\x6f\x69\x64\x5f\x73\x69\x6e\x67\x6c"
                                    "\x65\x61\x72\x67\x91\x2a";
    dispatcher.event_handle.bind("dummy_void_singlearg",
...
TEST_F(binding_test, memfunc_void_multiarg) {
    ...
    const unsigned char raw_msg[] = "\x94\x00\x00\xb3\x64\x75\x6d\x6d\x79\x5f"
                                    "\x76\x6f\x69\x64\x5f\x6d\x75\x6c\x74\x69"
                                    "\x61\x72\x67\x92\xcd\x01\x6b\x0c";
    dispatcher.event_handle.bind("dummy_void_multiarg",
...
TEST_F(dispatch_test, unbound_func_error_response) {
    dispatcher.event_handle.bind("foo", &dummy_void_singlearg);
...
TEST_F(dispatch_test, unique_names_zeroarg) {
    dispatcher.event_handle.bind("foo", &dummy_void_zeroarg);
    EXPECT_THROW(dispatcher.event_handle.bind("foo", &dummy_void_zeroarg), std::logic_error);
}

TEST_F(dispatch_test, unique_names_singlearg) {
    dispatcher.event_handle.bind("foo", &dummy_void_singlearg);
    EXPECT_THROW(dispatcher.event_handle.bind("foo", &dummy_void_singlearg), std::logic_error);
}

TEST_F(dispatch_test, unique_names_multiarg) {
    dispatcher.event_handle.bind("foo", &dummy_void_multiarg);
    EXPECT_THROW(dispatcher.event_handle.bind("foo", &dummy_void_multiarg), std::logic_error);
}
